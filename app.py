...
navbar = dbc.Navbar(
    [
        html.A(
            ...
            dbc.Row(
                [
                    dbc.Col(html.Img(src=app.get_asset_url('fav-music.png'), height="30px")),
        ...
        dbc.DropdownMenu(
            [dbc.DropdownMenuItem("Short term", href="/top_user_tracks_short_term", id="tracks-short-link"), dbc.DropdownMenuItem("Medium term",href="/top_user_tracks_medium_term",id="tracks-medium-link"), dbc.DropdownMenuItem("Long term", href="/top_user_tracks_long_term", id="tracks-long-link")],
            label="Top tracks",
            nav=True,
            color="primary"
        ),
        dbc.DropdownMenu(
            [dbc.DropdownMenuItem("Short term", href="/top_user_artists_short_term", id="artists-short-link"), dbc.DropdownMenuItem("Medium term",href="/top_user_artists_medium_term",id="artists-medium-link"), dbc.DropdownMenuItem("Long term", href="/top_user_artists_long_term", id="artists-long-link")],
            label="Top artists",
            nav=True,
        ),
...
@app.callback(
    dash.dependencies.Output(component_id='page-content', component_property='children'),
    [dash.dependencies.Input(component_id='url',component_property='pathname')])
def display_page(pathname):
    # backend call - GET USER DATA

    # page variables
    data_path_names = ['dashboard','top_user_tracks_short_term','top_user_tracks_medium_term','top_user_tracks_long_term','top_user_artists_short_term','top_user_artists_medium_term','top_user_artists_long_term']
    page_description = ''
    data_table= None
    page_content = ''
    page_text = ''
